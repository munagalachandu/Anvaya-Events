...
import { Calendar, Award, MapPin, CalendarDays, Clock, CheckCircle, Link, ExternalLink, Upload, GraduationCap, X,Trophy, Cpu, Gamepad2, BookOpen } from 'lucide-react';
                  ...
                  {loadingAchievements ? (
                    ...
                    <div className="rounded-md border">
                      {achievements.map(achievement => (
                        <div 
                          key={achievement.id} 
                           className="grid grid-cols-12 gap-2 md:gap-4 p-4 items-center border-b last:border-b-0 hover:bg-gray-50 transition-colors">
                          ...
                          <div className="col-span-2">
  <Badge className={`flex items-center gap-1 ${getCategoryColor(achievement.event_category || 'Other')}`}>
    {getCategoryIcon(achievement.event_category || 'Other')}
    {achievement.event_category || 'Not specified'}
  </Badge>
</div>
                          <div className="col-span-2">
                            <Badge 
